...
#
# THIS SCRIPT IS MEANT TO BE CALLED FROM THE PROJECT ROOT LIKE:
#  $ ./i18n/tbe_levels_i18n.sh
#
...
function create_ts_file {
  ...
  lconvert i18n/tbe_levels.pot -o i18n/tbe_levels_en.ts
  echo "Done"
}
