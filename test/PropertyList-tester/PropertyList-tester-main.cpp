...
bool TestPropertyList::runTests(void)
{
    ...
    check(myPL.property2Bool("Bool1", &myBool, false) == true
          && myBool == true,   "Bool1 was correctly retrieved\n");
    check(myPL.property2Bool("NoBool", &myBool, false) == false
          && myBool == true, "Failed key lookup doesn't touch variable\n");
    check(myPL.property2Bool("Bool5", &myBool, false) == true
          && myBool == false,  "Bool5 was correctly retrieved\n");
    check(myPL.property2Bool("Bool2", &myBool, false) == true
          && myBool == true,   "Bool2 was correctly retrieved\n");
    check(myPL.property2Bool("Bool6", &myBool, false) == false
          && myBool == true,  "Bool6 was correctly ignored\n");
    check(myPL.property2Bool("Bool5", &myBool, false) == true
          && myBool == false,  "Bool5 was correctly retrieved again\n");
    check(myPL.property2Bool("Bool4", &myBool, false) == false
          && myBool == false, "Bool4 was correctly ignored\n");
    check(myPL.property2Bool("Bool7", &myBool, false) == false
          && myBool == false, "Bool7 was correctly ignored\n");
    check(myPL.property2Bool("Bool3", &myBool, false) == true
          && myBool == true,   "Bool3 was correctly retrieved\n");

    myPL.setProperty("Bool8", true);
    myPL.setProperty("Bool9", false);
    myPL.setProperty("Bool5", true);

    check(myPL.property2Bool("Bool9", &myBool, false) == true
          && myBool == false,   "Bool9 was correctly retrieved\n");
    check(myPL.property2Bool("Bool8", &myBool, false) == true
          && myBool == true,   "Bool8 was correctly retrieved\n");
    check(myPL.property2Bool("Bool8", &myBool, false) == true
          && myBool == true,   "Bool8 was correctly retrieved\n");
...
bool TestPropertyWithDefaults::runTests(void)
{
    ...
    check(myPL.property2Bool("Bool1", &myBool, true) == true
          && myBool == true,   "Bool1 was correctly retrieved\n");
    check(myPL.property2Bool("NoBool", &myBool, true) == false
          && myBool == true, "Failed key lookup doesn't touch variable\n");
    check(myPL.property2Bool("Bool2", &myBool, true) == true
          && myBool == true,   "default value Bool2 was correctly retrieved\n");
    check(myPL.property2Bool("Bool3", &myBool, true) == true
          && myBool == false,   "default value Bool3 was correctly retrieved\n");
    check(myPL.property2Bool("Bool4", &myBool, true) == true
          && myBool == true,   "real Bool4 gets preference over default\n");
    check(myPL.property2Bool("Bool5", &myBool, true) == false
          && myBool == true,   "Bool5 default is invalid, variable untouched\n");

    myPL.removeProperty("Bool4");
    check(myPL.property2Bool("Bool4", &myBool, true) == true
          && myBool == false,   "default Bool4 gets chosen once real value is gone\n");
