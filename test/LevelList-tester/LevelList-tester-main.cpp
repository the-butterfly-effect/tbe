...
bool TestLevelList1::runTests(void)
{
    ...
    check (myMeta1.theTitle.english() == "The Butterfly Effect 101",
           "Check for basic English name of title level1");
    check (myMeta1.theTitle.result("nl_NL") == "Het vlindereffect (beginnerscursus)",
           "Check for dutch translation of title level1");
    check (myMeta1.theDescription.result("de_AT") == "Deutsche Beschreibung",
           "Check Austrian German translation of description level1");
