...
public:
    ...
    {
        return "AbstractObjectForTesting";
    }
    virtual b2BodyType getObjectType   () const
    {
...
public:
    ...
    virtual const QString getName      () const
    {
        return "AbstractObjectForTesting2";
    }
...
bool TestAbstractObjectInit::runTests(void)
{
    ...
    check(myWorldPtr->theObjectPtrList.count() == 0,
          "creating AbstractObject doesn't add it to World\n");
    ...
    check(myWorldPtr->theObjectPtrList.count() == 0,
          "create Physics body doesn't add AbstractObject to World\n");
