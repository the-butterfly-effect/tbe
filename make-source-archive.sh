...
find $2/levels/draft -name '*.xml' -o -name '*.svg' -o -name '*.png' -o -name '*.jpg' -o -name 'README' >>$MANIFEST
find $2/levels/elce09 -name '*.xml' -o -name '*.svg' -o -name '*.png' -o -name '*.jpg' -o -name 'README' >>$MANIFEST
find $2/levels/jumpingjack -name '*.xml' -o -name '*.svg' -o -name '*.png' -o -name '*.jpg' -o -name 'README' >>$MANIFEST
find $2/levels/angry -name '*.xml' -o -name '*.svg' -o -name '*.png' -o -name '*.jpg' -o -name 'README' >>$MANIFEST
