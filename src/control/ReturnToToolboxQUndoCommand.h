...
#ifndef RETURNTOTOOLBOXQUNDOCOMMAND_H
#define RETURNTOTOOLBOXQUNDOCOMMAND_H
...
/// by the user.
class ReturnToToolboxQUndoCommand : public AbstractQUndoCommand
{
public:
    explicit ReturnToToolboxQUndoCommand(ViewItem* anViewItemPtr,
