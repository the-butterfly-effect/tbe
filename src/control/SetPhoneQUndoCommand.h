...
#ifndef SETPHONEQUNDOCOMMAND_H
#define SETPHONEQUNDOCOMMAND_H
...
/// setting/adjusting a phone number.
class SetPhoneQUndoCommand : public AbstractQUndoCommand
{
    Q_OBJECT

public:
    explicit SetPhoneQUndoCommand(ViewItem* anViewItemPtr,
